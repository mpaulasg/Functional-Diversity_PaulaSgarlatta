...
# loading data
spatial_metadata <- read.csv(here::here("data", "using biomass-maxN" ,  "SpatialUVC_metadata_transect.csv") )
load(here::here("outputs/", "using biomass-maxN", "spatial_alpha_transect.RData") )

kelp_metadata <- read.csv(here::here("data", "using biomass-maxN" ,"TemporalBRUV_metadata_transect.csv") )
...
## Haven't tried these ones with transect data
