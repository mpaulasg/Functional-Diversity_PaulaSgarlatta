...
load(here::here("outputs/", "using biomass-maxN", "FD_beta_kelp_Hill.RData") )
load(here::here("outputs/", "using biomass-maxN", "TD_beta_kelp_Hill.RData") )


load(here::here("outputs/", "using biomass-maxN", "FD_beta_spatial_Hill.RData") )
load(here::here("outputs/","using biomass-maxN", "TD_beta_spatial_Hill.RData") )
...
TD_beta_toplot <- rbind(TD_beta_kelp_done, TD_beta_spatial_done )
...
hab_colors <- c(Kelp="seagreen4", I="blue", M="lightsalmon1", O="firebrick3")
...
plot_dissim_taxo_Hill <- ggplot(taxo_diss_Hill, 
  ...
  scale_color_manual(values=hab_colors, name="Habitat", breaks = c("Kelp", "I", "M", "O"), 
                     labels=c("Kelp", "Inshore", "Midshelf", "Offshore")) + 
  scale_fill_manual(values=hab_colors, name="Habitat", breaks = c("Kelp", "I", "M", "O"), 
                    labels=c("Kelp", "Inshore","Midshelf", "Offshore")) + 
...
FD_beta_toplot <- rbind(FD_beta_kelp_done, FD_beta_spatial_done )
...
ggsave(figure3_Hill, file=here::here("outputs/", "using biomass-maxN", "figure3_Hill.png"),
