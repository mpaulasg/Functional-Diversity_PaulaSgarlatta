...
load(here::here("outputs/", "using biomass-maxN", "FD_beta_kelp_Hill_sites.RData") )
load(here::here("outputs/", "using biomass-maxN", "TD_beta_kelp_Hill_sites.RData") )
...
hab_colors <- c(Kelp="seagreen4", I="#2C6BAA", M="lightsalmon1", O="firebrick3")
...
plot_dissim_func_Hill <- ggplot(FD_dissim_Hill, mapping = aes(color=Habitat, fill=Habitat)) +
  ...
  scale_color_manual(values=hab_colors, name="Habitat", breaks = c("Kelp", 
    "I", "M","O"),labels=c("Kelp", "Inshore","Midshelf",
                                      "Offshore")) + 
...
ggsave(figure2_Hill, file=here::here("outputs/","using biomass-maxN", "figure2_Hill_biomass.png"), 
