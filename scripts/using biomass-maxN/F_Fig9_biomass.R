...
plot_sp_nm <- c( "Trachinops_taeniatus", "Epinephelus_fasciatus","Gymnothorax_thyrsoidea","Thalassoma_lutescens", 
                 "Brachaelurus_waddi" ,"Orectolobus_halei", "Austrolabrus_maculatus")
