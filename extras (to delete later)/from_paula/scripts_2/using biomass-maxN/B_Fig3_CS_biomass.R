...
for ( z in 1:length(pairs_axes) ) {
  ...
  # loop on years
  for (h in row.names(kelp_years_sp) ) {
...
ggsave(figure3, file=here::here("outputs/", "using biomass-maxN", "Figure3_biomass.png"),
